...
local text_color = '#7a88bc'
local bg_color = '#d4d6e4'
local icon_color = '#d4d6e4'
-- See: https://github.com/glepnir/galaxyline.nvim
-- Modified by ecosse
...
local colors = {
  ...
  statsicon = icon_color,
  statsbg   = bg_color,
  statstext = text_color,
...
table.insert(gls.left, {
  GitIcon = {
    ...
    highlight = { colors.textbg, colors.giticon }
  }
})
table.insert(gls.left, {
  GitMid = {
...
table.insert(gls.left, {
  LspIcon = {
    ...
    highlight = { colors.textbg, colors.lspicon }
  }
})
table.insert(gls.left, {
  LspMid = {
...
table.insert(gls.right, {
  TypeFileFormatIcon = {
    ...
    highlight = { colors.textbg, colors.typeicon }
  }
})
table.insert(gls.right, {
  TypeMid = {
    provider = function() return rightbracket .. ' ' end,
    highlight = { colors.textbg, colors.typebg }
  }
})
    ...
    FileName = {
      provider = function()
        ...
        if EcoVim.statusline.path == 'relative' then
          ...
          local pathWithFileName = fname:gsub(vim.fn.getcwd() .. '/', '') .. ' '
...
table.insert(gls.right, {
  FileSize = {
    provider = 'FileSize',
    separator = '  ',
    separator_highlight = { colors.textbg, colors.typebg },
    highlight = { colors.typetext, colors.typebg }
  }
})
table.insert(gls.right, {
...
table.insert(gls.right, {
  StatsIcon = {
    ...
    highlight = { colors.textbg, colors.statsicon }
  }
})
table.insert(gls.right, {
  StatsMid = {
    provider = function() return rightbracket .. ' ' end,
    highlight = { colors.textbg, colors.statsbg }
  }
})
table.insert(gls.right, {
  PerCent = {
...
table.insert(gls.right, {
  VerticalPosAndSize = {
    ...
    separator = '',
    separator_highlight = { colors.textbg, colors.statsbg },
    highlight = { colors.textbg, colors.statsbg }
  }
})
table.insert(gls.right, {
